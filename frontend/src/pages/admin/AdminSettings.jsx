...
export default function AdminSettings(){
  ...
  async function save(){
    try{
      const normalizedColors=Object.fromEntries(Object.keys(DEFAULT_THEME).filter(k=>!['fontFamily','sectionFonts'].includes(k)).map(k=>[k,normalizeColor(draft[k])||DEFAULT_THEME[k]]))
      const normalized={
        ...normalizedColors,
