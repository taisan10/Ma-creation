      ...
      <div className="wrap">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          <Industry3DCard
            ...
            icon={Factory}
            title="Manufacturing"
            description="Industrial goods, machinery, components and OEM-led supply opportunities."
          />
          <Industry3DCard
            type="healthcare"
            icon={HeartPulse}
            title="Healthcare"
            description="Medical supplies, equipment, diagnostics and healthcare services."
          />
          <Industry3DCard
            type="it"
            icon={Laptop2}
            title="IT & Digital"
            description="Software, hardware, technology services and digital solutions."
          />
          <Industry3DCard
            type="services"
            icon={Building2}
            title="Business Services"
            description="Professional, facility, manpower, training and operational services."
          />
        </div>
      </div>
    </section>
